...
// Jalankan: npm install react-simple-wysiwyg
import Editor from "react-simple-wysiwyg"; 
// Jalankan: npm install react-html-parser
...
function PublishFormModal({ isOpen, onClose, onSubmit, initialData, isLoading }) {
  ...
  if (!isOpen || !initialData) return null; // Jangan render jika tidak ada data
          ...
          <div className="overflow-y-auto pr-2 flex-grow space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              ...
              <div>
                ...
                <div className="text-sm text-gray-900 mt-1 p-2 border border-gray-300 rounded-md bg-white min-h-[100px] prose">
                  {parse(initialData.specificRequirements || '<i>Tidak ada detail</i>')}
                </div>
              </div>
            </div>
            {/* --- BATAS BAGIAN 1 --- */}
