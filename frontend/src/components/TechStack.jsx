...
const TechStack = () => {
  // Data teknologi dan tools PT Tech XYZ
  const techItems = [
    {
      title: "BIM (Building Information Modeling)",
      description:
        "Teknologi pemodelan 3D untuk perencanaan, desain, dan manajemen proyek konstruksi gedung kesehatan secara digital.",
      iconSvg: (
        <svg
    ...
    {
      title: "IoT untuk Gedung Pintar",
      description:
        "Implementasi sensor IoT untuk monitoring gedung kesehatan, kontrol suhu, kelembaban, dan sistem keamanan otomatis.",
      iconSvg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="48"
    ...
    },
    {
      ...
      description:
        "Infrastruktur cloud untuk hosting aplikasi manajemen proyek, data storage, dan backup sistem konstruksi.",
      iconSvg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="48"
    ...
    },
    {
      ...
      description:
        "Platform digital untuk tracking progress konstruksi, manajemen tim, penjadwalan, dan pelaporan proyek real-time.",
      iconSvg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="48"
    ...
    },
    {
      ...
      description:
        "Deployment aplikasi berbasis container untuk konsistensi environment dan kemudahan scaling aplikasi IT.",
      iconSvg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="48"
    ...
    },
    {
      ...
      description:
        "Pengelolaan dan maintenance server Linux untuk hosting aplikasi web, database, dan sistem enterprise.",
      iconSvg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="48"
    ...
    {
      title: "Network Infrastructure (Mikrotik)",
      description:
        "Konfigurasi dan manajemen jaringan menggunakan Mikrotik untuk keamanan dan performa jaringan optimal.",
      iconSvg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="48"
    ...
    },
    {
      ...
      description:
        "Implementasi sistem keamanan jaringan, firewall, dan monitoring ancaman untuk proteksi infrastruktur IT.",
      iconSvg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="48"
    ...
    {
      title: "Monitoring & Analytics (Grafana)",
      description:
        "Dashboard monitoring real-time untuk infrastruktur IT, server performance, dan network traffic analysis.",
      iconSvg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="48"
    ...
    {
      title: "Automation Tools (n8n)",
      description:
        "Workflow automation untuk otomatisasi proses bisnis, notifikasi proyek, dan integrasi sistem.",
      iconSvg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="48"
    ...
    },
    {
      ...
      description:
        "Pengelolaan database MySQL, PostgreSQL, MongoDB untuk aplikasi web dan sistem informasi proyek.",
      iconSvg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="48"
    ...
    },
    {
      ...
      description:
        "Pengembangan aplikasi mobile untuk monitoring proyek konstruksi, absensi digital, dan laporan lapangan.",
      iconSvg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="48"
      ...
      <section data-aos="zoom-in-down">
        ...
        <div className="my-4 py-4">
          ...
          <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-blue-900">
            Teknologi Modern untuk Konstruksi Digital dan Infrastruktur IT
          </h2>
        </div>
